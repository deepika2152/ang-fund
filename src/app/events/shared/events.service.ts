...
export class EventService
{
  ...
  //Observable in angular is an interface to do async operations
 ...
 const EVENTS:IEvent[]= [
    {
      ...
      location: {
        address: '1057 DT ,near water tank',
        city: 'London',
        country: 'England'

      },
      onlineURL: 'www.dp.com',
     sessions: [
        {
          id: 1,
    ...
    location: {
        address: 'The NG-NL Convention Center ',
        city: 'Amsterdam',
     country: 'Netherlands',
    },
    onlineURL: 'www.ngnl.com',
      sessions: [
        {
          id: 1,
...

    {
      ...
      time:  '9:00 am',
      price: 800.00,
      imageUrl: '/assets/images/ng-california.png',
      location: {
        address: 'The Excalibur',
        city: 'California',
        country: 'USA'
      },
       onlineURL: 'www.ngcalifornia.com',
      sessions: [
        {
          id: 1,
          name: "Gambling with Angular",
